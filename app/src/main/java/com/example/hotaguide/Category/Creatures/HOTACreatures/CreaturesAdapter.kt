...
class CreaturesAdapter(
    private val hotaList: List<HOTACreatures>, var context: Context
) : RecyclerView.Adapter<CreaturesAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            intent.putExtra("creature_name", hotaList[p1].name)
