...
import com.example.hotaguide.Jebus.starters.castles.bulwark.eikthurn.JebusStarterHeroEikthurnActivity
import com.example.hotaguide.Jebus.starters.castles.bulwark.kynr.JebusStarterHeroKynrActivity
import com.example.hotaguide.R

class JebusStarterHeroBulwarkListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroBulwarkListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Кунр") {
                intent = Intent(context, JebusStarterHeroKynrActivity::class.java)
            }

            if (p0.name.text == "Ейктхурн") {
                intent =  Intent(context, JebusStarterHeroEikthurnActivity::class.java)
            }
