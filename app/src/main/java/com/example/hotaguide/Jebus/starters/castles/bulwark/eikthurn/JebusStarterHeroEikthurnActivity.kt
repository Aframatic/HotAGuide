package com.example.hotaguide.Jebus.starters.castles.bulwark.eikthurn
...
class JebusStarterHeroEikthurnActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hero_image.setImageResource(R.drawable.hero_eikthurn)
        ...
        special_image.setImageResource(R.drawable.mountain_ram_portrait)
        creature_image_1.setImageResource(R.drawable.mountain_ram_portrait)
        creature_image_2.setImageResource(R.drawable.mountain_ram_portrait)
        creature_image_3.setImageResource(R.drawable.mountain_ram_portrait)
        ...
        hero_skill_name_2.text = "Логистика"
        special_name.text = "Специализация: Горные Бараны"
        special_description.text =
            "Увеличивает скорость Горных Баранов и Архарова на 1, а их атаку и защиту — на 20% за каждые 2 уровня героя (с округлением вверх)."
        creature_name_1.text = "6-8"
        creature_name_2.text = "6-8"
        creature_name_3.text = "6-8"
    }
}