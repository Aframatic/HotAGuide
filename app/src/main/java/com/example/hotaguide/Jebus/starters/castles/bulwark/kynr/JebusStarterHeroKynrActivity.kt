package com.example.hotaguide.Jebus.starters.castles.bulwark.kynr
...
class JebusStarterHeroKynrActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hero_image.setImageResource(R.drawable.hero_kynr)
        hero_skill_image_1.setImageResource(R.drawable.basic_estates_large)
        hero_skill_image_2.setImageResource(R.drawable.basic_tactics_large)
        special_image.setImageResource(R.drawable.kobold_portrait)
        creature_image_1.setImageResource(R.drawable.kobold_portrait)
        creature_image_2.setImageResource(R.drawable.kobold_portrait)
        creature_image_3.setImageResource(R.drawable.kobold_portrait)

        attack_skill.text = "0"
        defense_skill.text = "4"
        power_skill.text = "1"
        knowledge_skill.text = "1"
        hero_skill_name_1.text = "Поместья"
        hero_skill_name_2.text = "Тактика"
        special_name.text = "Специализация: Кобольды"
        special_description.text =
            "Увеличивает скорость Кобольдов и Кобольдов-Старшин на 1, а их атаку и защиту — на 10% за каждый уровень героя (с округлением вверх)."
