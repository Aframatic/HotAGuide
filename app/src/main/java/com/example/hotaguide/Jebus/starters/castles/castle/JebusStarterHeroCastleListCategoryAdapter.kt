package com.example.hotaguide.Jebus.starters.castles.castle
...
class JebusStarterHeroCastleListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroCastleListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Валеска") {
                intent = Intent(context, JebusStarterHeroValeskaActivity::class.java)
            }

            if (p0.name.text == "Лойнис") {
                intent =  Intent(context, JebusStarterHeroLoynisActivity::class.java)
            }
