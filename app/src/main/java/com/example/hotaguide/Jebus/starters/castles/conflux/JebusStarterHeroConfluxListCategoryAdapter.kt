package com.example.hotaguide.Jebus.starters.castles.conflux
...
import com.example.hotaguide.Jebus.starters.castles.conflux.luna.JebusStarterHeroLunaActivity
import com.example.hotaguide.R

class JebusStarterHeroConfluxListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroConfluxListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Луна") {
                intent = Intent(context, JebusStarterHeroLunaActivity::class.java)
            }
