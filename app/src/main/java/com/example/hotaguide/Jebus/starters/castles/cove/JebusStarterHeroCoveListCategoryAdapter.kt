...
import com.example.hotaguide.Jebus.starters.castles.cove.cassiopeia.JebusStarterHeroCassiopeiaActivity
import com.example.hotaguide.R

class JebusStarterHeroCoveListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroCoveListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Кассиопея") {
                intent = Intent(context, JebusStarterHeroCassiopeiaActivity::class.java)
            }
