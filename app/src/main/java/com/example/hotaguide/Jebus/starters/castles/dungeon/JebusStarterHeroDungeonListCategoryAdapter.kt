package com.example.hotaguide.Jebus.starters.castles.dungeon
...
import com.example.hotaguide.Jebus.starters.castles.dungeon.shakti.JebusStarterHeroShaktiActivity
import com.example.hotaguide.R

class JebusStarterHeroDungeonListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroDungeonListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Шахти") {
                intent = Intent(context, JebusStarterHeroShaktiActivity::class.java)
            }
