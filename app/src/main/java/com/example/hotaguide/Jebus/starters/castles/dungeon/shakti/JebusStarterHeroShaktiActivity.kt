package com.example.hotaguide.Jebus.starters.castles.dungeon.shakti
...
class JebusStarterHeroShaktiActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hero_image.setImageResource(R.drawable.hero_shakti)
        ...
        special_image.setImageResource(R.drawable.troglodyte_portrait)
        creature_image_1.setImageResource(R.drawable.troglodyte_portrait)
        creature_image_2.setImageResource(R.drawable.troglodyte_portrait)
        creature_image_3.setImageResource(R.drawable.troglodyte_portrait)
        ...
        special_name.text = "Специализация: Троглодиты"
        special_description.text =
            "Увеличивает скорость Троглодитов и Троглодитов-Охотников на 1, а их атаку и защиту — на 10% за каждый уровень героя (с округлением вверх)."
