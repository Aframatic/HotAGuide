package com.example.hotaguide.Jebus.starters.castles.factory
...
import com.example.hotaguide.Jebus.starters.castles.factory.henrietta.JebusStarterHeroHenriettaActivity
import com.example.hotaguide.Jebus.starters.castles.factory.sam.JebusStarterHeroSamActivity
import com.example.hotaguide.R

class JebusStarterHeroFactoryListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroFactoryListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Сэм") {
                intent =  Intent(context, JebusStarterHeroSamActivity::class.java)
            }
