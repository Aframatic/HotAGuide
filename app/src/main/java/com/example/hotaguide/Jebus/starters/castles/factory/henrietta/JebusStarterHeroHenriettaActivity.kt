package com.example.hotaguide.Jebus.starters.castles.factory.henrietta
...
class JebusStarterHeroHenriettaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hero_image.setImageResource(R.drawable.hero_henrietta)
        hero_skill_image_1.setImageResource(R.drawable.basic_leadership_large)
        hero_skill_image_2.setImageResource(R.drawable.luck)
        special_image.setImageResource(R.drawable.halfling_portrait)
        creature_image_1.setImageResource(R.drawable.halfling_portrait)
        creature_image_2.setImageResource(R.drawable.halfling_portrait)
        creature_image_3.setImageResource(R.drawable.halfling_portrait)

        attack_skill.text = "3"
        defense_skill.text = "1"
        power_skill.text = "1"
        knowledge_skill.text = "1"
        hero_skill_name_1.text = "Лидерство"
        hero_skill_name_2.text = "Удача"
        special_name.text = "Специализация: Полурослики"
        special_description.text =
            "Увеличивает скорость Полуросликов и Полуросликов-Гренадёров на 1, а их атаку и защиту — на 10% за каждый уровень героя (с округлением вверх)."
