package com.example.hotaguide.Jebus.starters.castles.factory.sam
...
class JebusStarterHeroSamActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hero_image.setImageResource(R.drawable.hero_sam)
        ...
        special_image.setImageResource(R.drawable.mechanic_portrait)
        creature_image_1.setImageResource(R.drawable.mechanic_portrait)
        creature_image_2.setImageResource(R.drawable.mechanic_portrait)
        creature_image_3.setImageResource(R.drawable.mechanic_portrait)
        ...
        special_name.text = "Специализация: Механики"
        special_description.text =
            "Увеличивает скорость Механиков и Инженеров на 1, а их атаку и защиту — на 20% за каждый уровень героя (с округлением вверх)."
        creature_name_1.text = "7-9"
        creature_name_2.text = "7-9"
        creature_name_3.text = "7-9"
    }
}