...
import com.example.hotaguide.Jebus.starters.castles.fortress.drakon.JebusStarterHeroDrakonActivity
import com.example.hotaguide.R

class JebusStarterHeroFortressListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroFortressListCategoryAdapter.MyViewHolder>() {
