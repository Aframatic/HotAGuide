package com.example.hotaguide.Jebus.starters.castles.inferno.ignatius
...
class JebusStarterHeroIgnatiusActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hero_image.setImageResource(R.drawable.hero_ignatius)
        hero_skill_image_1.setImageResource(R.drawable.basic_tactics_large)
        hero_skill_image_2.setImageResource(R.drawable.basic_interference_large)
        special_image.setImageResource(R.drawable.imp_portrait)
        creature_image_1.setImageResource(R.drawable.imp_portrait)
        creature_image_2.setImageResource(R.drawable.imp_portrait)
        creature_image_3.setImageResource(R.drawable.imp_portrait)

        attack_skill.text = "2"
        defense_skill.text = "2"
        power_skill.text = "1"
        knowledge_skill.text = "1"
        hero_skill_name_1.text = "Тактика"
        hero_skill_name_2.text = "Помехи"
        special_name.text = "Специализация: Бесы"
        special_description.text =
            "Увеличивает скорость Бесов и Чертей на 1, а их атаку и защиту — на 10% за каждый уровень героя (с округлением вверх)."
