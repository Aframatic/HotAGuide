package com.example.hotaguide.Jebus.starters.castles.necropolis
...
import com.example.hotaguide.Jebus.starters.castles.castle.loynis.JebusStarterHeroLoynisActivity
import com.example.hotaguide.Jebus.starters.castles.castle.valeska.JebusStarterHeroValeskaActivity
import com.example.hotaguide.Jebus.starters.castles.necropolis.thant.JebusStarterHeroThantActivity
import com.example.hotaguide.R

class JebusStarterHeroNecropolisListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroNecropolisListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Тант") {
                intent = Intent(context, JebusStarterHeroThantActivity::class.java)
            }
