package com.example.hotaguide.Jebus.starters.castles.rampart
...
import com.example.hotaguide.Jebus.starters.castles.rampart.ivor.JebusStarterHeroIvorActivity
import com.example.hotaguide.R

class JebusStarterHeroRampartListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroRampartListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Ивор") {
                intent = Intent(context, JebusStarterHeroIvorActivity::class.java)
            }
