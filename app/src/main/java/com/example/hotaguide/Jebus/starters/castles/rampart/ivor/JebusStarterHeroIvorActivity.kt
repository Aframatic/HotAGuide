package com.example.hotaguide.Jebus.starters.castles.rampart.ivor
...
class JebusStarterHeroIvorActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        hero_image.setImageResource(R.drawable.hero_ivor)
        hero_skill_image_1.setImageResource(R.drawable.basic_archery_large)
        hero_skill_image_2.setImageResource(R.drawable.basic_offense_large)
        special_image.setImageResource(R.drawable.wood_elf_portrait)
        creature_image_1.setImageResource(R.drawable.centaur_portrait)
        creature_image_2.setImageResource(R.drawable.wood_elf_portrait)
        creature_image_3.setImageResource(R.drawable.wood_elf_portrait)

        attack_skill.text = "1"
        defense_skill.text = "3"
        power_skill.text = "1"
        knowledge_skill.text = "1"
        hero_skill_name_1.text = "Стрельба"
        hero_skill_name_2.text = "Нападение"
        special_name.text = "Специализация: Эльфы"
        special_description.text =
            "Увеличивает скорость Лесных Эльфов и Благородных Эльфов на 1, а их атаку и защиту — на 20% за каждые 3 уровеня героя (с округлением вверх)."
        creature_name_1.text = "12-24"
        creature_name_2.text = "2-4"
        creature_name_3.text = "2-4"
    }
}