...
import com.example.hotaguide.Jebus.starters.castles.stronghold.gretchin.JebusStarterHeroGretchinActivity
import com.example.hotaguide.Jebus.starters.castles.stronghold.tyraxor.JebusStarterHeroTyraxorActivity
import com.example.hotaguide.R

class JebusStarterHeroStrongholdListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroStrongholdListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Гретчин") {
                intent = Intent(context, JebusStarterHeroGretchinActivity::class.java)
            }

            if (p0.name.text == "Тираксор") {
                intent =  Intent(context, JebusStarterHeroTyraxorActivity::class.java)
            }
