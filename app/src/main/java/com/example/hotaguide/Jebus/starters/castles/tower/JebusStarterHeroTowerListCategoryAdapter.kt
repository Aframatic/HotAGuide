package com.example.hotaguide.Jebus.starters.castles.tower
...
import com.example.hotaguide.Jebus.starters.castles.tower.solmyr.JebusStarterHeroSolmyrActivity
import com.example.hotaguide.R

class JebusStarterHeroTowerListCategoryAdapter(
    private val hotaList: List<HOTAPattern>, var context: Context
) : RecyclerView.Adapter<JebusStarterHeroTowerListCategoryAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(p0: MyViewHolder, p1: Int) {
        ...
        p0.bt.setOnClickListener {
            ...
            if (p0.name.text == "Солмир") {
                intent = Intent(context, JebusStarterHeroSolmyrActivity::class.java)
            }
